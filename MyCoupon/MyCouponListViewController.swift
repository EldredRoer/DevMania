...
class MyCouponListViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        jsonResult = AsyncHttpTask.sharedInstance.returnJSONResult()
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.ivPhoto.image = UIImage(named: "cutedog")
        return cell
    }
